...
export function buildConversationPrompt(
  ...
  return [
    ...
    "Return exactly one JSON object with no outer Markdown or code fence. The reply string may contain the small, safe Markdown subset supported by the Web conversation and WeChat iLink:",
    "Use headings only when they improve scanning, plus bold, short bullet or numbered lists, inline or fenced code, links, and compact tables. Never emit raw HTML, JavaScript, data URLs, or decorative formatting.",
